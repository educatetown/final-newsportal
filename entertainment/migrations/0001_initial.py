# Generated by Django 3.0.3 on 2020-06-24 13:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture1', models.ImageField(blank=True, null=True, upload_to=entertainment.models.upload_location)),
                ('picture2', models.ImageField(blank=True, null=True, upload_to=entertainment.models.upload_location)),
                ('picture3', models.ImageField(blank=True, null=True, upload_to=entertainment.models.upload_location)),
                ('thumbnail', models.ImageField(blank=True, null=True, upload_to=entertainment.models.upload_location)),
