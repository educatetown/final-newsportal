    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture1', models.ImageField(blank=True, null=True, upload_to=tech.models.upload_location)),
                ('picture2', models.ImageField(blank=True, null=True, upload_to=tech.models.upload_location)),
                ('picture3', models.ImageField(blank=True, null=True, upload_to=tech.models.upload_location)),
                ('thumbnail', models.ImageField(blank=True, null=True, upload_to=tech.models.upload_location)),
